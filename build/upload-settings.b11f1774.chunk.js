"use strict";
(self["webpackChunkurban_cobix"] = self["webpackChunkurban_cobix"] || []).push([[2714],{
...
const SettingsPage = () => {
  ...
  (0,react.useEffect)(() => {
    ...
    const getData = async () => {
      try {
        const {
          data: { data }
        } = await get((0,utils/* getRequestUrl */.rh)("settings"), {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await put((0,utils/* getRequestUrl */.rh)("settings"), modifiedData);
      dispatch({
