(self["webpackChunkurban_cobix"] = self["webpackChunkurban_cobix"] || []).push([[6823],{
...
const CreatePage = () => {
  ...
  const params = (0,react_router/* useRouteMatch */.W5)("/settings/roles/duplicate/:id");
  const id = get_default()(params, "params.id", null);
  const { isLoading: isLayoutLoading, data: permissionsLayout } = (0,hooks/* useFetchPermissionsLayout */.Sr)();
  const { permissions: rolePermissions, isLoading: isRoleLoading } = (0,hooks/* useFetchRole */.Gs)(id);
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.g, null, /* @__PURE__ */ react.createElement(helper_plugin_esm/* SettingsPageTitle */.x7, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit, values, errors, handleReset, handleChange }) => /* @__PURE__ */ react.createElement(helper_plugin_esm/* Form */.lV, { noValidate: true }, /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
      ...
      values.description
    ))))), !isLayoutLoading && !isRoleLoading ? /* @__PURE__ */ react.createElement(Box/* Box */.a, { shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(
...
var ChevronUp = __webpack_require__(19319);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/ChevronDown.js
var ChevronDown = __webpack_require__(81526);
// EXTERNAL MODULE: ./node_modules/lodash/get.js
var get = __webpack_require__(58156);
var get_default = /*#__PURE__*/__webpack_require__.n(get);
...
const EditPage = () => {
  ...
  const { lockApp, unlockApp } = (0,helper_plugin_esm/* useOverlayBlocker */.MA)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.z1)();
  const { isLoading: isLayoutLoading, data: permissionsLayout } = (0,hooks/* useFetchPermissionsLayout */.Sr)(id);
  const {
    role,
    permissions: rolePermissions,
    isLoading: isRoleLoading,
    onSubmitSucceeded
  } = (0,hooks/* useFetchRole */.Gs)(id);
